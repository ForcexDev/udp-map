...
insert into careers (faculty_id, name, name_en) values
  ('ingenieria', 'Ingeniería Civil Informática', 'Computer Science Engineering'),
  ...
  ('economia', 'Contador Auditor', 'Accounting and Auditing');
...
insert into categories (id, kind, name, name_en, color, svg_path, ttl_hours) values
  ...
  ('entrada', 'report', 'Entrada', 'Entrance', '#9d2235', 'M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z', null),
  ...
  ('deporte-evento', 'event', 'Deportivo', 'Sports', '#16a34a', 'M19 5h-2V3H7v2H5c-1.1 0-2 .9-2 2v1c0 2.55 1.92 4.63 4.39 4.94.63 1.5 1.98 2.63 3.61 2.96V19H7v2h10v-2h-4v-3.1c1.63-.33 2.98-1.46 3.61-2.96C19.08 12.63 21 10.55 21 8V7c0-1.1-.9-2-2-2zM5 8V7h2v3.82C5.84 10.4 5 9.3 5 8zm14 0c0 1.3-.84 2.4-2 2.82V7h2v1z', null),
