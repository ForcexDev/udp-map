...
insert into categories (id, kind, name, name_en, color, svg_path, ttl_hours) values
  ...
  ('escalera', 'report', 'Escalera', 'Stairs', '#475569', 'M3 21v-4h5v-4h5V9h5V5h3v16H3z', 720),
  ...
  ('computacion', 'report', 'Sala de computación', 'Computer lab', '#06B6D4', 'M20 18c1.1 0 1.99-.9 1.99-2L22 6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2H0v2h24v-2h-4zM4 6h16v10H4V6z', 12),
