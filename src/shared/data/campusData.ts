...
export const FACULTIES: Faculty[] = [
  ...
  f('salud', 'Facultad de Salud y Odontología', 'Faculty of Health and Dentistry', 'ejercito', -33.45021323380484, -70.66032844628639, 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=200&h=200&fit=crop&q=60'),
  f('derecho', 'Facultad de Derecho', 'Faculty of Law', 'republica', -33.45021136315485, -70.66809868354323, 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=200&h=200&fit=crop&q=60'),
  f('postgrado-derecho', 'Facultad de Postgrado Derecho UDP', 'Postgraduate Law Faculty', 'republica', -33.45005627543808, -70.66777883883336),
  f('arquitectura', 'Facultad de Arquitectura, Arte y Diseño', 'Faculty of Architecture, Art and Design', 'republica', -33.449475699743495, -70.66693499798215, 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=200&h=200&fit=crop&q=60'),
  f('comunicacion', 'Facultad de Comunicación y Letras', 'Faculty of Communication and Letters', 'republica', -33.45010, -70.66166, 'https://images.unsplash.com/photo-1478720568477-152d9b164e26?w=200&h=200&fit=crop&q=60'),
  f('ciencias-sociales', 'Facultad de Ciencias Sociales e Historia', 'Faculty of Social Sciences and History', 'ejercito', -33.45119, -70.66088),
  f('educacion', 'Facultad de Educación', 'Faculty of Education', 'republica', -33.44991, -70.66186),
  f('biblioteca', 'Biblioteca Nicanor Parra', 'Nicanor Parra Library', 'republica', -33.45130, -70.66125, 'https://images.unsplash.com/photo-1521587760476-6c12a4b040da?w=200&h=200&fit=crop&q=60'),
  ...
  f('aulario', 'Aulario UDP', 'UDP Classrooms', 'ejercito', -33.45100, -70.66037),
  f('filosofia', 'Instituto de Filosofía', 'Institute of Philosophy', 'ejercito', -33.45009, -70.66060),
  f('deportes', 'UDP Centro de Deportes', 'UDP Sports Center', 'ejercito', -33.45133335303932, -70.65959113362774),
  f('dti', 'UDP Oficina DTI', 'UDP IT Office (DTI)', 'ejercito', -33.45093220625878, -70.6597607833481),
  f('comercio', 'Facultad de Comercio', 'Faculty of Commerce', 'ejercito', -33.450894923920764, -70.6606009331726),
]
